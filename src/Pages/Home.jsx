    ...
    <div className="relative">
        <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="ml-auto lg:col-start-2 lg:max-w-2xl">
                <p className="text-3xl font-semibold p-2 leading-6 text-blue-500 uppercase">
                    KEKAYU PROJECT
                </p>
                ...
                <p className="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-300">
                    Build a simply and powered collaborative space for all your team. Solid team, share idea, measureble progress, you have a fully responsible, it&#x27;s never be simply and efficient like before.
                </p>
            ...
            <div className="relative mt-10 lg:-mx-4 relative-20 lg:mt-0 lg:col-start-1">
                <div className="relative space-y-4">
                    <div className="flex items-end justify-center space-x-4 lg:justify-start">
                        <img className="w-32 rounded-lg shadow-lg md:w-56" width="200" src={testi1} alt="1"/>
                        <img className="w-40 rounded-lg shadow-lg md:w-64" width="260" src={testi2} alt="2"/>
                    </div>
                    <div className="flex items-start justify-center ml-12 space-x-4 lg:justify-start">
                        <img className="w-24 rounded-lg shadow-lg md:w-40" width="170" src={testi3} alt="3"/>
                        <img className="w-32 rounded-lg shadow-lg md:w-56" width="200" src={testi4} alt="4"/>
                    </div>
                </div>
            </div>
        </div>
