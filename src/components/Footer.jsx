...
<footer className="text-center lg:text-left text-blue-600">
  <div className="flex justify-center items-center lg:justify-between p-6 border-b border-blue-300">
    ...
    <div className="flex justify-center">
      <a href="http://facebook.com/kekayuproject" className="mr-6 text-blue-600">
      ...
      <a href="http://twitter.com/kekayuproject" className="mr-6 text-blue-600">
      ...
      <a href="http://instagram.com/kekayuproject" className="mr-6 text-blue-600">
      ...
      <a href="http://linkedin.com/in/kekayuproject" className="mr-6 text-blue-600">
  ...
  <div className="text-center p-6 bg-blue-200">
    <span>© 2023 </span>
    <a className="text-blue-600 font-semibold" href="#">Kekayu Project</a>
  </div>
</footer>
    )
};